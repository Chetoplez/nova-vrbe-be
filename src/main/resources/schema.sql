CREATE TABLE GenericUser (
  ...
  role VARCHAR(20) NOT NULL, --ADMIN , USER , Narrator
  PRIMARY KEY (UserId)
);
...
adminOnly BIT,
adminViewOnly BIT,
ownedby INT, -- SE è UNA BACHECA DI GILDA,
forumType VARCHAR(3) ,
PRIMARY KEY (FORUMID)
);
...
adminOnly bit,
forumId int,
rankVisibility int, --sezioni che puoi vedere da un certo grado in poi (guildLevel)
subforumType VARCHAR(3) ,
...
BODY TEXT,
AUTHOR INT,
IDCOMMENT INT, --referenzia un commento per rispondere
POSTID INT,
CREATEDAT DOUBLE,
...
MISSIVAID INT NOT NULL AUTO_INCREMENT,
CHTO VARCHAR(500) NOT NULL,
CHFROM INT ,
BODY TEXT,
SUBJECT TEXT,
SENTAT DOUBLE,
...
DELETED BIT,
TYPE VARCHAR (3),
PRIMARY KEY ( MISSIVAID )
);

CREATE TABLE DELETED_MISSIVE (
MISSIVAID INT NOT NULL AUTO_INCREMENT,
CHTO VARCHAR(500) NOT NULL,
CHFROM INT ,
BODY TEXT,
